...
import 'package:latkuis_ppam/pages/homepage.dart';
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: Image.asset('assets/images/loginpage.png', width: 200, height: 200,),
                  ),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor:
              (isLoginSuccess) ? const Color(0xFF8E24AA) : Colors.red,
